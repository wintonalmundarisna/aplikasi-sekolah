...
//                no++;
                int id = rs.getInt("id");
                String thn_ajaran = rs.getString("tahun_ajaran");
    ...
    private void initComponents() {
        ...
        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/k.jpg"))); // NOI18N
        jLabel20.setText("DATA TAHUN AJARAN");
        ...
        tahun_ajaran.setFont(new java.awt.Font("Agency FB", 0, 18)); // NOI18N
        tahun_ajaran.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tahun_ajaranActionPerformed(evt);
            }
        });
        tahun_ajaran.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tahun_ajaranKeyTyped(evt);
            }
        });
            ...
            .addGroup(jPanel61Layout.createSequentialGroup()
                ...
                .addGroup(jPanel61Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel61Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(tahun_ajaran, javax.swing.GroupLayout.PREFERRED_SIZE, 229, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18))
        );
        jPanel61Layout.setVerticalGroup(
            ...
            .addGroup(jPanel61Layout.createSequentialGroup()
                ...
                .addGroup(jPanel61Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tahun_ajaran, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
    ...
    private void btn_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMouseClicked
        String thn_ajaran = tahun_ajaran.getText();
        if(thn_ajaran.isEmpty()){
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        ...
        try {
            String sql ="UPDATE tahun_ajaran SET tahun_ajaran=? WHERE id=?";
            PreparedStatement st = conn.prepareStatement(sql);
            st.setString(1, thn_ajaran);
            st.setString(2, id);
    ...
    private void tahun_ajaranKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tahun_ajaranKeyTyped
        if (Character.isAlphabetic(evt.getKeyChar())) {
            evt.consume();
        }
    }//GEN-LAST:event_tahun_ajaranKeyTyped

    private void tbl_dataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_dataMouseClicked
       int selectedRow = tbl_data.getSelectedRow();
       if (selectedRow !=-1) {
           String thn_ajaran = tbl_data.getValueAt(selectedRow, 1).toString();
           
           tahun_ajaran.setText(thn_ajaran);
    ...
    private void t_cariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t_cariKeyTyped
        ...
        try {
            String sql = "Select * From tahun_ajaran WHERE tahun_ajaran LIKE ?";
            PreparedStatement st = conn.prepareStatement(sql);
            st.setString(1,"%" + cari + "%" );
            ...
            while(rs.next()){
                ...
                Object[] rowData = {id,tahun_ajaran};
                model.addRow(rowData);
            }
            rs.close();
            st.close();
    ...
    public static javax.swing.JTextField tahun_ajaran;
