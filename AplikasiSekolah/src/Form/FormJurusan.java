...
//                no++;
                int id = rs.getInt("id");
                String thn_ajaran = rs.getString("jurusan");
    ...
    private void initComponents() {
        ...
        jLabel20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/jurusan.png"))); // NOI18N
        jLabel20.setText("DATA JURUSAN");
        ...
        jurusan.setFont(new java.awt.Font("Agency FB", 0, 18)); // NOI18N
    ...
    private void btn_simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_simpanMouseClicked
        String jurusan = FormJurusan.jurusan.getText();
        if(jurusan.isEmpty()){
    ...
    private void btn_ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ubahActionPerformed
        ...
        try {
            String sql ="UPDATE jurusan SET jurusan=? WHERE id=?";
            PreparedStatement st = conn.prepareStatement(sql);
            st.setString(1, jrsn);
            st.setString(2, id);
...
//        }
    ...
    private void tbl_dataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_dataMouseClicked
       int selectedRow = tbl_data.getSelectedRow();
       if (selectedRow !=-1) {
           String jrsn = tbl_data.getValueAt(selectedRow, 1).toString();
    ...
    private void t_cariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_t_cariKeyTyped
        ...
        try {
            ...
            while(rs.next()){
                int id = rs.getInt("id");
                String jrsn = rs.getString("jurusan");
                
                Object[] rowData = {id,jrsn};
                model.addRow(rowData);
            }
            rs.close();
            st.close();
    ...
    public static javax.swing.JTextField jurusan;
